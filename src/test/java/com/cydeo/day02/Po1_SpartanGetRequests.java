...
public class Po1_SpartanGetRequests {
     ...
     * And Content type shouşd be application/json
     */
    @Test
    public void getAllSpartans(){
        ...
        //StatusCode() contentType() methods are specificly created by them. so ther is connection method
